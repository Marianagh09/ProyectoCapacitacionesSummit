...
{
	public class GetCopmletedCoursesData : DataService
	{
		public GetCopmletedCoursesData(DataDict dataDictionary) : base(dataDictionary)
		{
		}
		...
		private static readonly String fCurses = "SELECT " +
			...
			"WHERE ass.state = 1   AND ass.USER_ID =  " + DataDictSecurity.ParTellerId;
	}
}
